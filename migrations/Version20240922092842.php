 ...
 */
final class Version20240922092842 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coupon (id INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE product (id INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE tax_rate (id INT NOT NULL, PRIMARY KEY(id))');
    }
